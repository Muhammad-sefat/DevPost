...
`;
    ...
    return `You are an expert technical content writer and developer advocate. Write exactly 5 high-quality, engaging, and professional LinkedIn posts based on the developer's activity today.
...
1. Write exactly 5 distinct suggestions (e.g. Storytelling format, Technical deep-dive, Humorous hook, Bulleted key-learnings).
